...
public class ManageBorrowersActivityTest extends SystemTest
{
    ...
    private ManageBorrowersActivityObject manageBorrowersActivityObject = new ManageBorrowersActivityObject(mDevice);
    ...
    @Test
    public void testBorrowersScreen() throws UiObjectNotFoundException
    {
        manageBorrowersActivityObject.clickBorrowerItem("Γιακουμάκης");
    }
}
