...
public class ManageLoansActivityTest extends SystemTest
{
    ...
    private ManageLoansActivityObject manageLoansActivityObject = new ManageLoansActivityObject(mDevice);
    ...
    {
        manageLoansActivityObject.navigateToScreen("Δραγούμης");
        manageLoansActivityObject.verifyLoansAreVisible("Don Quixote");
    }
}
