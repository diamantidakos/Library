...
public class ManagePublishersActivityObject extends AbstractActivityObject
{
    ...
    UiObject libraryManagePublishersActivity;
    ...
    public void navigateToApp() throws UiObjectNotFoundException
    {
        ...
        libraryManagePublishersActivity = mDevice.findObject(new UiSelector().packageName(APP_PACKAGE));
        assertTrue("Unable to detect Library App", libraryManagePublishersActivity.exists());
    }

    public void clickPublisherItem() throws UiObjectNotFoundException
    {
        ...
        UiObject bookObj = mDevice.findObject(new UiSelector().textContains("McGraw-Hill Education"));
