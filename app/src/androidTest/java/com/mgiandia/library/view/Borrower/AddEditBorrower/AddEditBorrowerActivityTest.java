...
public class AddEditBorrowerActivityTest extends SystemTest
{
    ...
    private AddEditBorrowerActivityObject addEditBorrowerActivityObject = new AddEditBorrowerActivityObject(mDevice);
