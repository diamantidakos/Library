...
import com.mgiandia.library.view.Book.AddEditBook.AddEditBookActivityObject;
import com.mgiandia.library.view.SystemTest;

import org.junit.Before;
import org.junit.Test;

public class BookDetailsActivityTest extends SystemTest
{
    ...
    private BookDetailsActivityObject bookDetailsActivityObject = new BookDetailsActivityObject(mDevice);
    ...
    {
        bookDetailsActivityObject.clickEditButton("The Odyssey");
        bookDetailsActivityObject.changeISBN("5555");
        bookDetailsActivityObject.scrollToBottom();
        bookDetailsActivityObject.clickSaveButton();
        bookDetailsActivityObject.verifyBookIsVisible("The Odyssey");
    }
}
