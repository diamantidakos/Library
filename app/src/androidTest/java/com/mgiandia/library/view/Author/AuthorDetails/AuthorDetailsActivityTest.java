...
public class AuthorDetailsActivityTest extends SystemTest
{
    ...
    {
        authorDetailsActivityObject.clickEditButton("Αβέρωφ");
        authorDetailsActivityObject.changeSurname("LastName");
        authorDetailsActivityObject.clickSaveButton();
        authorDetailsActivityObject.verifyAuthorIsVisible("LastName");
    }

    @Test
    public void testShowBooksButtonClick() throws UiObjectNotFoundException
    {
        authorDetailsActivityObject.clickAppearBooksButton("Γεωργιάδης");
        authorDetailsActivityObject.verifyBookIsVisible("Don Quixote");
    }
}
