...
public class ManageAuthorsActivityTest extends SystemTest
{
    ...
    private ManageAuthorsActivityObject manageAuthorsActivityObject = new ManageAuthorsActivityObject(mDevice);
