...
public abstract class Initializer
{
    ...
    public void prepareData()
    {
        ...
        borrowerDao.save(new Borrower(borrowerDao.nextId(), "Μανόλης", "Γιακουμάκης",
                ...
                new EmailAddress("mgia@aueb.listItem"), new TelephoneNumber("2108203292"), borrowerCategoryDao.find(5/*"Καθηγητής"*/)));
        ...
        borrowerDao.save(new Borrower(borrowerDao.nextId(), "Νίκος", "Διαμαντίδης",
                ...
                new EmailAddress("nad@aueb.listItem"), new TelephoneNumber("2108203292"), borrowerCategoryDao.find(5/*"Προπτυχιακός Φοιτητής"*/)));
