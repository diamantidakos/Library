...
public class AddEditPublisherPresenter
{
     ...
     * @return Ένα boolean ανάλογα με το αν ήταν
     ...
     * @return Επιστρέφει ένα boolean ανάλογα με το
    ...
    /**
     * Κατά την αποθήκευση του δανειζόμενου ελέγχει
     * αν το όνομα, η πόλη, η οδός και το επώνυμο είναι πάνω από
     * 2 χαρακτήρες και κάτω από 15. Επίσης ελέγχει
     * αν ήταν ορθή η διεύθυνση ηλεκτρονικού ταχυδρομείου
     * και υπάρχουν 2 έως 10 αριθμητικά ψηφία στον αριθμό και
     * στον ταχυδρομικό κώδικα. Τέλος εμφανίζει μήνυμα ότι
     * ήταν επιτυχείς η εγγραφή ή η τροποποίηση αν εκπληρώθηκαν
     * οι από πάνω έλεγχοι.
     */
