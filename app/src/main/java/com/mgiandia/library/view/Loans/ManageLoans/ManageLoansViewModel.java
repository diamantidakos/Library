...
public class ManageLoansViewModel extends ViewModel implements ButtonClicked
{
    ...
    public ManageLoansPresenter getPresenter(ManageLoansView view)
    {
        presenter = new ManageLoansPresenter(view, loanDAO, new BorrowerDAOMemory());
        return presenter;
    }
