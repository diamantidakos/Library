...
public class ZipCodeTest {
    ...
    public void equalsAndHashCode(){
        ...
        Assert.assertEquals(true, new ZipCode("11111").isValid());
        Assert.assertEquals("11111", new ZipCode("11111").toString());
        Assert.assertEquals("11111", new ZipCode("11111").getCode());
    }
}
