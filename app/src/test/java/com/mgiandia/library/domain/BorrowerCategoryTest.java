...
public class BorrowerCategoryTest {
    ...
    public void memberFunctions() {
        ...
        borrowerCategory.setDescription("test");
        Assert.assertEquals("test", borrowerCategory.getDescription());

        category.setMaxLendingDays(111);
        Assert.assertEquals(111, category.getMaxLendingDays());

        category.setMaxLendingItems(222);
        Assert.assertEquals(222, category.getMaxLendingItems());
    }
}
