...
Η διεπαφή `EmailProvider` θα έχει μόνο μία μέθοδο τη μέθοδο `sendEmail` με πιθανή υπογραφή  `sendEmail(EmailAddress from, EmailAddress to, String subject, String body)`  
