...
[*Παρακάτω δίνεται μία περιγραφή του περιεχομένων του Εγγράφου Προδιαγραφών Απαιτήσεων Λογισμικού (ΕΠΑΛ) που βασίζεται σε πρότυπο περιπτώσεων χρήσης. Για κάθε ενότητα του εγγράφου γίνεται παραπομπή σε παραδείγματα του βιβλίου “Μ Γιακουμάκης, Ν. Διαμαντίδης, Τεχνολογία Λογισμικού, Unibooks, 2021”*]
...
*Ένα διάγραμμα περιβάλλοντος που βοηθά στην κατανόηση του συστήματος σε σχέση με το περιβάλλον του. Βλέπε το σχήμα 3-6 του παραδείγματος 3-1 στη σελίδα 113 του βιβλίου*]

## <a id="definitions"></a> Ορισμοί ακρώνυμα και συντομογραφίες

[*Ένας πίνακας ακρωνύμων και συντομογραφιών που χρησιμοποιούνται στο έγγραφο. Ένας δεύτερος πίνακας με ορισμούς. Οι ορισμοί λαμβάνονται από το γλωσσάρι αν αυτό υπάρχει. Βλέπε πίνακα 3-5 του παραδείγματος 3-1 στη σελίδα 116.*]
...
[*Εισάγουμε το διάγραμμα περιπτώσεων χρήσης. Βλέπε σχήμα 3-17 του παραδείγματος 3-11 στη σελίδα 151 του βιβλίου.* 

*Εισάγουμε έναν πίνακα με τους κωδικούς, τους τίτλους και μία σύντομη περιγραφή των περιπτώσεων χρήσης. Βλέπε πίνακα 3-8  του παραδείγματος 3-11 στη σελίδα 150 του βιβλίου*]
...
[*Ένας πίνακας των ενδιαφερομένων (stakeholders) με τις ανάγκες τους. Βλέπε πίνακα 3-6 του  παραδείγματος 3-2 στη σελίδα 120 του βιβλίου.*]

### <a id="actors"></a> Actors του συστήματος

[*Ένα πίνακας με του actors του συστήματος. Βλέπε πίνακας 3-7 παραδείγματος 3-11 στη σελίδα 149 του βιβλίου.*]
...
*Βλέπε , το παράδειγμα 3-4 στη σελίδα 127, το παράδειγμα 3-7 στη σελίδα 141 και το παράδειγμα 3-8 στη σελίδα 142.*]
...
[*Βλέπε πίνακα 6-4 του παραδείγματος 6-1 στη σελίδα 258*]
...
[*Εισάγουμε ένα διάγραμμα κλάσεων με την αρχική έκδοση των κλάσεων λογισμικού. Βλέπε σχήμα 5-65 του παραδείγματος 5-9 στη σελίδα 229 του βιβλίου*]
