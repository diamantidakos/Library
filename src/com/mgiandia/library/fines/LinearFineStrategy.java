...
abstract class LinearFineStrategy implements FineStrategy {
     ...
     * @return Το πόστιμο καθυστέρησης
     */
    public final Money calculateFine(SimpleCalendar due,
            SimpleCalendar returnDate, Money dailyFine) {
     ...
     */
    protected abstract long calculateStrategyOverdue(SimpleCalendar due,
